...
1. Adquiere un dispositivo LoRa compatible con Meshtastic. Puedes encontrar una lista de dispositivos recomendados en nuestra sección de [dispositivos compatibles](/guias/dispositivos-compatibles/).
2. Flashea tu hardware con el firmware Meshtastic. Puedes seguir nuestra guía de [flasheo de firmware](/guias/flasheo-firmware/) para obtener instrucciones detalladas.
3. Descarga la aplicación Meshtastic en tu teléfono móvil. Está disponible para Android e iOS.
4. Configura tu dispositivo siguiendo nuestra guía de [configuración](/configuracion/ajustes-recomendados/).
5. Únete a nuestra comunidad en WhatsApp para interactuar con otros usuarios, hacer preguntas y compartir tus experiencias. [Enlace grupo de WhatsApp](https://chat.whatsapp.com/Bkw5MiV8RqVL6GRutNyZNS?mode=ac_c).
